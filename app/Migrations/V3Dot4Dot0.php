 ...
 */
class V3Dot4Dot0 extends AbstractMigration
{
    /**
     * @inheritdoc
     */
    ...
    {
        Util::removedir('application/Espo/Modules/Crm');
        Util::removedir('application/Espo/Modules/TreoCrm');
        Util::removedir('client/modules/crm');
        Util::removedir('client/modules/treo-crm');
    }
